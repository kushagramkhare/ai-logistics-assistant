...
agent = create_agent(
    ...
    tools=tools,
    system_prompt=(
        "You are a helpful assistant. Always use the logistics_search tool to find facts. "
        "If the tool says information is missing or irrelevant, inform the user "
...
if __name__ == "__main__":
    try:
        print("🚀 System Online...")
        user_input = "When is Salman's birthday?"
        res = agent.invoke({"messages": [{"role": "user", "content": user_input}]})
